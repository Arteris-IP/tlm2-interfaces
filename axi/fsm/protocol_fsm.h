...
struct Request : bsc::state<Request, AxiProtocolFsm> { // @suppress("Class has a virtual method and non-virtual destructor")
    ...
    typedef mpl::list<bsc::transition<EndReq, Operation>,
...
struct Operation : bsc::state<Operation, AxiProtocolFsm> { // @suppress("Class has a virtual method and non-virtual destructor")
    Operation(my_context ctx)
    : my_base(ctx) {}
    ~Operation() override {
