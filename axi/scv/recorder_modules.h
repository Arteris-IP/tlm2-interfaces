...
public:
    ...
    typename BASE::template target_socket_type<BUSWIDTH>::base_type::fw_interface_type* get_fw_if() { return isckt.get_base_port().operator->(); }

    typename BASE::template target_socket_type<BUSWIDTH>::base_type::bw_interface_type* get_bw_if() { return tsckt.get_base_port().operator->(); }
